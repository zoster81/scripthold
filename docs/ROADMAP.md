...
- **R27 is `ACTIVE`.** The explicitly reprioritized connector reliability gate completed on 2026-08-15 and R27 implementation resumed. Phases 0-9 are complete; Phase 10 data, infrastructure, hardware and document formats is the first incomplete R27 implementation phase.
