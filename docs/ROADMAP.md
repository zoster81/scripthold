...
- **R27 is `ACTIVE`.** The explicitly reprioritized connector reliability gate completed on 2026-08-15 and R27 implementation resumed. Phases 0-15 are complete; Phase 16 capability/corpus completion is the first incomplete R27 implementation phase.
