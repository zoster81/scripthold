...
- Release line: `2.1.0`, the first Scripthold-named semantic release and the first release line assigned to the fork-owned Scripthold Registry identity.
...
- Registry: `2.1.0` uses `io.github.zoster81/scripthold`; `2.0.0` remains under the historical `io.github.zoster81/mcp-file-tools` identity.
