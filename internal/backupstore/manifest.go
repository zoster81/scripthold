...
func validateCaptureRequest(request CaptureRequest) (CaptureRequest, error) {
	...
	case SourceOperationEdit, SourceOperationPatchPackage, SourceOperationFilesystemPackage, SourceOperationRestore, SourceOperationManageBOM, SourceOperationConvertEncoding:
	default:
