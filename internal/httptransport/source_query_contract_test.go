...
func TestSourceQueryMatchesDirectAndHTTPAdapters(t *testing.T) {
	...
	directSource := sourceQueryFindToolJSON(t, directTools.Tools, "source_query")
	httpSource := sourceQueryFindToolJSON(t, httpTools.Tools, "source_query")
...
func sourceQueryFindToolJSON(t *testing.T, tools []*mcp.Tool, name string) string {
	t.Helper()
