...
- [`source_query`](TOOLS.md#source_query) — frozen R27 read-only search/relations/context contract; the native query engine is not implemented yet.
