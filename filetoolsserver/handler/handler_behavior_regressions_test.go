...
func TestReadTextFileLineNumbers(t *testing.T) {
	root := t.TempDir()
...
func TestDirectoryAndSearchSorting(t *testing.T) {
	root := t.TempDir()
...
func TestGitignoreTraversal(t *testing.T) {
	root := t.TempDir()
...
func TestGrepModesPatternsAndPaging(t *testing.T) {
	root := t.TempDir()
	for name, content := range map[string]string{
		"a.txt": "foo one\nbar two\nnone\n",
		"b.txt": "foo three\n",
...
func TestConvertEncodingBatchDryRun(t *testing.T) {
	root := t.TempDir()
...
func TestEditFuzzyAndPatch(t *testing.T) {
	root := t.TempDir()
...
func TestFuzzyEditRejectsAmbiguity(t *testing.T) {
	root := t.TempDir()
...
func TestFuzzyEditRejectsEqualScoreCandidates(t *testing.T) {
	root := t.TempDir()
...
func TestPatchRejectsInconsistentNewStart(t *testing.T) {
	root := t.TempDir()
...
func TestFuzzyDeleteDoesNotLeaveIndentation(t *testing.T) {
	root := t.TempDir()
...
func TestGrepFileModeReducesRetainedOutput(t *testing.T) {
	root := t.TempDir()
...
func TestGrepCountDoesNotStarveLaterFiles(t *testing.T) {
	root := t.TempDir()
...
func TestListDirectoryMetadataSortSkipsExternalSymlink(t *testing.T) {
	root := t.TempDir()
	outside := t.TempDir()
...
func TestPatchRejectsMultiFileWithoutMutation(t *testing.T) {
	root := t.TempDir()
...
func TestRecursiveToolsFailClosedOnInvalidGitignore(t *testing.T) {
	root := t.TempDir()
	outside := t.TempDir()
...
func TestConvertEncodingRejectsBackupTargetCollision(t *testing.T) {
	root := t.TempDir()
...
func FuzzUnifiedPatch(f *testing.F) {
...
func TestConvertEncodingBatchPartialCommitIsExplicit(t *testing.T) {
	root := t.TempDir()
