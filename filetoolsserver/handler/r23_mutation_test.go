...
func TestR23ByteMutationPreviewStoreIsBoundedOneShotAndExpiring(t *testing.T) {
...
func TestR23ByteMutationPreviewConcurrentClaimSucceedsOnce(t *testing.T) {
...
func TestR23ManageBOMRequiredDefaultNoOpNeedsNoStoreAndChangedPreviewFailsClosed(t *testing.T) {
...
func TestR23ManageBOMCapabilityBindsKindIdentityBytesAndReplay(t *testing.T) {
	root := canonicalHandlerTestDir(t)
...
func TestR23ConvertEncodingPreviewIsSideEffectFreeAndApplyUsesExactBytes(t *testing.T) {
	root := canonicalHandlerTestDir(t)
...
func TestR23BackupHistoryAndCompareAreAuthorizedAndBounded(t *testing.T) {
...
func TestR23BackupCompareBinaryKeepsFingerprintsWithoutDiff(t *testing.T) {
	fixture := newBackupStoreHandlerFixture(t)
...
func TestR23PreviewApplyInputsRejectMutationOverrides(t *testing.T) {
