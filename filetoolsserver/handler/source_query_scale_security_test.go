...
func TestManySmallFilesWarmConcurrencyAndGenerationSwap(t *testing.T) {
...
func TestAllowedRootCancellationAndNoUnrelatedSourceLeakage(t *testing.T) {
	root := canonicalHandlerTestDir(t)
...
func TestSourceQueryFilesHaveNoHiddenExecutionOrNetworkImports(t *testing.T) {
