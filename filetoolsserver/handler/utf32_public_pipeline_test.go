...
func TestUTF32PublicTextPipeline(t *testing.T) {
	const content = "alpha\nbeta\nCittà Привет 中文 🌍\n"
...
func TestUTF32BOMlessAutoDetectionAndExplicitRead(t *testing.T) {
...
func TestUTF32MalformedInputFailsClosedWithoutMutation(t *testing.T) {
...
func TestUTF32GenericAndBOMConflictFailClosed(t *testing.T) {
	root := t.TempDir()
	h := NewHandler([]string{root})
	...
	original := append(fileEncoding.BOMBytesFor("utf-32-le"), encodeXTextFixture(t, "utf-32-le", "text")...)
